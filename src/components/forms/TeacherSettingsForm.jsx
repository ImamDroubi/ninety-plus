...
import updateTeacherSchema from "./schemas/updateTeacherSchema";
...
export default function TeacherSettingsForm(props) {
  ...
  const handleDataAppending = (data) => {
    ...
    if (bio != currentUser.about) updatedProfilePayload.append("about", bio);
  ...
  return (
    <>
      ...
      <form className="text-gray-900 text-sm" onSubmit={handleSubmit(onSubmit)}>
        ...
        {/* Bio  */}
        <SingleFormInputContainer error={errors.about?.message}>
