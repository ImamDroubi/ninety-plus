    ...
    <div className="sign-in">
      ...
      <div className="content flex w-full min-h-[35rem] lg:h-[89vh] lg:border-t-2 mb-6 md:mb[0] lg:mb-[0]">
        ...
        <div className="left flex flex-col items-center gap-6 w-full h-full justify-center lg:w-3/5 py-3">
          <h2 className="text-center text-gray-900 text-2xl font-bold">إنشاء حساب جديد</h2>
          <form action="" className="w-11/12 flex flex-col gap-4 lg:w-2/3">
            <div className="from-input  flex flex-col gap-2 w-full">
              <label htmlFor="f-name" className="text-gray-900">الاسم كاملاً</label>
              <div className="inputs flex flex-col gap-2 lg:flex-row lg:justify-between">
                <input type="text" placeholder="الاسم الأول" name="f-name" id="f-name" className="py-2 px-1 text-gray-500 border-2 border-gray-100 focus:border-primary-500 outline-none lg:w-4/6"/>
                <input type="text" placeholder="اسم العائلة" name="l-name" id="l-name" className="py-2 px-1 text-gray-500 border-2 border-gray-100 focus:border-primary-500 outline-none lg:w-4/6"/>
              </div>
            </div>
            <div className="from-input  flex flex-col gap-2 w-full">
              <label htmlFor="email" className="text-gray-900">البريد الإلكتروني</label>
              <input type="email" placeholder="test@example.com" name="email" id="email" className="py-2 px-1 text-gray-500 border-2 border-gray-100 focus:border-primary-500 outline-none"/>
            </div>
            <div className="passwords flex flex-col gap-2 lg:flex-row">
              ...
              <div className="from-input flex flex-col gap-2 w-full">
                <label htmlFor="re-password" className="text-gray-900">تأكيد كلمة السر</label>
                <input type="password" name="re-password" id="re-password" className="py-2 px-1 text-gray-500 border-2 border-gray-100 focus:border-primary-500 outline-none"/>
              </div>
            </div>
            <div className="form-bottom flex justify-between">
              <div className="form-input flex items-center gap-1">
                ...
                <label htmlFor="remember" className="text-gray-700">أوافق على <span className="text-secondary-500 hover:underline"><Link>شروط الاستخدام</Link> </span></label>
              </div>
              <Button
              text="تسجيل"
              />
