...
import {faVideo,faSpinner,faTrophy,faChalkboardUser} from '@fortawesome/free-solid-svg-icons'
...
export default function Overview({student}) {
  ...
  return (
    <>
      ...
      <section>
        <h2 className="mb-3 text-lg font-semibold">أكمل متابعة الدورات, {student.name.split(" ")[0]}</h2>
        <div className="flex justify-between lectures">
          <div className="lecture w-[15rem] h-[20rem] border-2 border-gray-100">
            ...
            <div className="p-1 border-b-2 info border-b-gray-100">
              <p className="mb-1 text-sm text-gray-600">رياضيات التوجيهي العلمي والصناعي</p>
